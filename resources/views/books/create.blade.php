            ...
            <div class="bg-white dark:bg-gray-800 overflowhidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="post" action="{{ route('book.store') }}" enctype="multipart/form-data"
                        ...
                        <div class="max-w-xl">
                            <label for="bookshelf_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Kategori RakBuku</label>
                            <select id="bookshelf" name="bookshelf_id" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-indigo-600 dark:focus:border-indigo-600 dark:text-gray-300 sm:text-sm"value="{{ old('bookshelf_id') }}" required>
